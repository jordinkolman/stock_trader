# Summary: This module contains the account definitions for the stock manager program.
# Author: Jordin Kolman
# Date: 9/24/2022

from stock_class import Stock

#Create Retirement_Account Class Here
class Retirement_Account:
    def __init__(self, balance, number):
        self.balance = balance
        self.number = number
    
#Create Subclass for Traditional Account Here
class Traditional(Retirement_Account):
    def __init__(self, balance, number):
        Retirement_Account.__init__(self, balance, number)
        self.Stock_List = [] #list of stocks invested

    def add_stock(self, stock_data):
        self.Stock_List.append(stock_data)
    
#Create Subclass for Robo Account Here
